...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0C0E10] text-gray-100 font-poppins">
      ...
      {/* Main Content */}
      <div className="max-w-4xl mx-auto p-4 flex flex-col h-[calc(100vh-85px)]  ">
        {/* Messages Area */}
        <div className="flex-1 overflow-y-auto mb-4 space-y-4 scrollbar-thin scrollbar-thumb-blue-500 scrollbar-track-gray-800">
          {messages.length === 0 && (
            <div className="text-center mt-20 animate-fadeIn">
              ...
              <h2 className="text-2xl font-bold mb-4 bg-gradient-to-r from-white to-gray-700 bg-clip-text text-transparent">
          ...
          {messages.map((message, index) => (
            ...
            >
              {/* <BorderBeam /> */}
              {message.type === "bot" && (
                <div className="w-8 h-8 rounded-full bg-gradient-to-r  flex items-center justify-center shadow-lg shadow-blue-500/20">
                  <Image
                    src={"/cutmologo2.png"}
                    alt="CUTM Logo"
                    width={25}
              ...
              <div
                className={`max-w-[80%] p-3 rounded-lg backdrop-blur-md shadow-lg ${
                  message.type === "user"
        ...
        {messages.length === 0 && (
          <div className="grid grid-cols-2 gap-4 mb-4 ">
            {sampleQueries.map((query, index) => (
              <ShineBorder
                className=" text-sm  relative flex h-[80%] w-full flex-col items-center justify-center overflow-hidden backdrop-blur-md   border  md:shadow-xl bg-gray-900/50  text-white  hover:bg-gray-800/50 transition-all duration-300 text-left hover:shadow-lg hover:shadow-blue-500/20 group  rounded-lg"
        ...
        <form onSubmit={handleSubmit} className="relative">
          <input
            ...
            className="w-full text-sm backdrop-blur-md bg-gray-900/50 rounded-lg pl-4 pr-12 py-4 focus:outline-none focus:ring-2 focus:ring-blue-500/50 border border-gray-700 focus:border-blue-500/50 transition-all duration-300"
          />
